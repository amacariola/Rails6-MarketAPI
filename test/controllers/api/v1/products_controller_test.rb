...
class Api::V1::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create product with an authorized user' do
  ...
  test 'should forbid create product if user not authorized' do
  ...
  test 'should forbid update product if not authorized' do
    patch api_v1_product_url(@product),
          params: { product: { title: @product.title } },
  ...
  test "should forbid deleting user product" do
    assert_no_difference('Product.count') do
